...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_reviung41(
    KC_0,            KC_1,     KC_2,     KC_3,     KC_3,      KC_PERC,            KC_CIRC,  KC_AMPR,  KC_ASTR,  KC_LPRN,  KC_RPRN,  KC_DEL,
    _______,         KC_4,     KC_5,     KC_6,     KC_6,      KC_PIPE,            KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  KC_GRV,   KC_TILD,
    _______,         KC_7,     KC_8,     KC_9,     KC_9,      KC_DQUO,            KC_HOME,  KC_END,   KC_PGUP,  KC_PGDN,  KC_PSCR,  RSFT_T(KC_SPC),
                                                   _______,   _______,  _______,  _______,  _______
  ),
  
  [_RAISE] = LAYOUT_reviung41(
    _______,         KC_F1,    KC_F2,    KC_F3,    KC_F4,     _______,            KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_LEAD,
